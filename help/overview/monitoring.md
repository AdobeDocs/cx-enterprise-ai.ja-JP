...
Adobe CX Enterprise](agentic-ai.md)の[Agentic AI ドキュメントには、既存のCX Enterprise アプリ ](agentic-ai.md#existing-apps-table)の[AI エージェントの使用状況モニタリングの対象範囲のエージェントが一覧表示されています。
