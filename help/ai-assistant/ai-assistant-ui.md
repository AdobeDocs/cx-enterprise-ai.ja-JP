...
| 適用範囲 | AI アシスタント（レガシー）は、アプリケーション固有の実装です。 | AI アシスタント（次世代型）を利用すれば、Adobe Experience Cloudのあらゆるアプリケーションで、統合されたAI アシスタント体験を実現できます。 |
...
Experience Cloud ホームインターフェイスで、左側のナビゲーションから&#x200B;**[!UICONTROL AI アシスタント]**&#x200B;を選択して、AI アシスタントのフルスクリーンビューを起動します。
