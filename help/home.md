...
Coworker Chatの実際の動作を確認するには、Playground](./coworker/playground-coworker-chat.md)の[Coworker Chatを説明するか、[AAからCJAへの移行データの検証](./coworker/data-validation-aa-cja.md)や[ コンバージョンのドロップオフの分析](./coworker/analytics-use-cases.md)などの実際のユースケースを読んでください。
