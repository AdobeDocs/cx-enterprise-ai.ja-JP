---
title: 共同作業者を使用したAEM Sites ページの作成
description: ビジュアルコンテンツフラグメントから構築された新しいプロモーションを自然言語を使用してAdobe CX Enterprise CoworkerでAEM Sites ページを作成する方法を説明します。
...
ht-degree: 0%
---
# 共同作業者を使用したAEM Sites ページの作成

Adobeの会話型AIである[Coworker](./overview.md)を使用して、ページエディターをクリックする代わりに、希望する内容を平易な言葉で記述してAEM Sites ページを作成します。

このビデオでは、Coworkerがチャットプロンプトを使用して、ビジュアルコンテンツフラグメントから構築されたWKND ホームページに新しいプロモーションを追加します。
