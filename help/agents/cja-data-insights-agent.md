...
>[!MORELIKETHIS]
>
>[ コンポーネント設定データ辞書計算指標を承認セグメントの共有](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-components/segments/seg-share)
