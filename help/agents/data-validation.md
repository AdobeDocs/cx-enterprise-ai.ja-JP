...
![AI アシスタントの応答。推論完了、検証概要、フィールド概要テーブルに、フィールドのパス、タイプ、有効な値が一覧表示されます。](./assets/validation/answer.png)
...
![左側に検証のストーリーと統計、右側に有効な値の拡張チャートのビジュアライゼーションが表示されたビューを分割](./assets/validation/split-screen.png)
...
![詳細なフィールドレベルの検証統計とグラフの視覚化を表示する拡張ビュー。](./assets/validation/expanded-view.png)
